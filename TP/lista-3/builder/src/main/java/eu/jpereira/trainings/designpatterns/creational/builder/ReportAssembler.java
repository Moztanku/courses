...
import eu.jpereira.trainings.designpatterns.creational.builder.builder.IReportBuilder;
...
public class ReportAssembler {
	 ...
	 * @return
	 */
	public Report getReport(IReportBuilder builder) {
        ...
        builder.buildReport();
        report.setReportBody(builder.returnReportBody());
