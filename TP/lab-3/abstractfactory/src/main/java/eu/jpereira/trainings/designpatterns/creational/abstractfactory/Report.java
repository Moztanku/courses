...
public class Report {
	 ...
	 * @param string
	 */
	public Report(IFactory reportType) {
		
		this.setHeader(reportType.createReportHeader());
		this.setBody(reportType.createReportBody());
		this.setFooter(reportType.createReportFooter());
