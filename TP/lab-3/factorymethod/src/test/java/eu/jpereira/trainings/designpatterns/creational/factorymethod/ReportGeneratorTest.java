...
public class ReportGeneratorTest extends AbstractReportingTest{
	...
	public void testCreateJSONReport() {
		...
		Report generatedReport = generator.generateReport(reportData, new JSONReport());
	...
	public void testCreateXMLReport() {
		ReportData reportData = createDummyReportData();
		ReportGenerator generator = new ReportGenerator();
		Report generatedReport = generator.generateReport(reportData, new XMLReport());
	...
	public void testCreateHTMLReport() {
		ReportData reportData = createDummyReportData();
		ReportGenerator generator = new ReportGenerator();
		Report generatedReport = generator.generateReport(reportData, new HTMLReport());
	...
	public void testCreatePDFReport() {
		ReportData reportData = createDummyReportData();
		ReportGenerator generator = new ReportGenerator();
		Report generatedReport = generator.generateReport(reportData, new PDFReport());
